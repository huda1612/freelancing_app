class StatusClasses {
  ...
  static const idle = StatusClasses._("idle");
  static const success = StatusClasses._("success");

  //---------------- error states ---------------------
  static const offlineError =
      StatusClasses._("offlineError", "الرجاء التحقق من اتصالك بالانترنت");
  static const serverError = StatusClasses._("serverError");
  static const permissionDenied =
      StatusClasses._("permissionDenied", "انتهت صلاحيتك، يرجى تسجيل الدخول");
  ...
  static const notFound =
      StatusClasses._("notFound", "البيانات المطلوبة غير موجودة أو تم حذفها");
  static const indexRequired = StatusClasses._(
      "indexRequired", "حدث خطأ في تحميل البيانات، يرجى المحاولة لاحقًا");
  static const invalidData = StatusClasses._("invalidData",
      "البيانات المدخلة غير صحيحة، يرجى التحقق والمحاولة مرة أخرى");
  static const unknown =
      StatusClasses._("unknown", "حدث خطأ غير متوقع، يرجى المحاولة مرة أخرى");
