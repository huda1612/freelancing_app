...
// class AppColors {
//   // الألوان الأساسية اللي عطيتك ياها أول شي
//   static const Color purple = Color(0xFF6C63FF);
//   static const Color blue = Color(0xFF4B75CB);
//   static const Color pink = Color(0xFFFF6BAA);
//   static const Color black = Color(0xFF000000);
//   static const Color white = Color(0xFFFFFFFF);

//   // إضافات جديدة حسب التعديلات الأخيرة
//   static const Color darkGreyBackground = Color(0xFF1C1C1E); // خلفية رمادي غامق
//   static const Color puzzleOrange = Color(0xFFFFA726);       // برتقالي
//   static const Color deepGreen = Color(0xFF2E7D32);          // أخضر غامق
// static const Color deepTeal = Color.fromARGB(255, 35, 94, 112);
